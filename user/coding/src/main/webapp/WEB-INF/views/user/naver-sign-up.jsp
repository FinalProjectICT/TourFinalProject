  ...
  <body>
                        ...
                        <form class="theme-form" action="insertUser" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group mb-0">
                            <div class="checkbox p-0">
                              ...
                              <br/><span id="checkboxError" class="validateError"></span>
                            </div>
    ...
    <script>
      $(document).ready(function () {
        ...
        if ('${naverUserInfo}' !== '') {
          var naverUserInfoString = '${naverUserInfo}';

          // JSON 문자열을 JavaScript 객체로 파싱
          var naverUserInfo = JSON.parse(naverUserInfoString);
          ...
          $('#user_name').val(naverUserInfo.response.name);
          $('#user_id').val("naver_"+naverUserInfo.response.id);
          $('#user_pass').val("naver_"+naverUserInfo.response.id);
          $('#user_tel').val(user_tel);
          $('#user_email').val(naverUserInfo.response.email);
          $('#birthdate').val(naverUserInfo.response.birthyear+"-"+naverUserInfo.response.birthday);
