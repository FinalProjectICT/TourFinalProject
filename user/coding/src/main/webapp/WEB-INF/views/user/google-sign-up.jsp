                ...
                <div class="offset-lg-3 col-lg-6 offset-sm-2 col-sm-8 col-12">
                    <div class="account-sign-in">
                        ...
                        <div class="login-with">
                            <h6>더 정확한 추천서비스를 위해 추가 정보를 입력해주세요.</h6>
                        </div>
                        <form class="theme-form" action="insertUser" method="post" enctype="multipart/form-data">
                          <!-- 이름 -->
                          <input class="form-control" type="hidden" id="user_name" name="user_name" value="${googleUserInfo.name}"  />
                          <!-- 아이디/비밀번호(not null이라 아이디와 동일하게 설정) -->
                          <input class="form-control" type="hidden" id="user_id" name="user_id" value="google_${googleUserInfo.id}" />
                          <input class="form-control" type="hidden" id="user_pass" name="user_pass" value="google_${googleUserInfo.id}" />
                          <!-- 메일주소 -->
                          <input class="form-control" type="hidden" id="user_email" name="user_email" value="${googleUserInfo.email}" />
                        ...
                        <div class="form-group" style="display: flex; gap: 10px;">
                          ...
                          <div class="form-group mb-0">
                            ...
                            <button class="btn btn-primary btn-block w-100" type="submit" id="submitBtn" style="height: 50px;">회원가입</button>
                          </div>

                             <!-- 추가된 부분: Google 사용자 정보 출력 -->
                          <div class="form-group mt-4">
                            <label class="col-form-label form-label-title">Google 사용자 정보:</label>
                            <pre>${googleUserInfo.id}</pre>
                          </div>
