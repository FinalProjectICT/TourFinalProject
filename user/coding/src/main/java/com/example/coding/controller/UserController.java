...
public class UserController {
	...
	public ModelAndView forgetPassword(HttpSession session, 
		...
		UserVO vo = userService.selectMember(user_email);
	...
	// 인증번호 확인
	@RequestMapping(value = "/auth-num", method = RequestMethod.POST)
	public String authNum(@RequestParam(value="email_auth") String email_auth,
