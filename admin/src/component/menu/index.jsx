            ...
            <li className={location.pathname === "/" ? "active" : ""}>
                <Link className="collapsed" to="/">
                  ...
                  >
                    ...
                    <span className="menu-bar__name">홈</span>
                  </span>
                </Link>
              </li>
              {/* <Dropdown
              ...
              <li className={location.pathname === "/user" ? "active" : ""}>
                <Link className="collapsed" to="/user">
                  <span className="menu-bar__text">
                    ...
                    <span className="menu-bar__name">회원</span>
                  </span>
                </Link>
              </li>

              {/* 여행 등록 및 상세(수정/삭제) 사이드 메뉴 */}
              <Dropdown
                name="여행지"
                dropdown={dropdown}
                setDropdown={handleDropdown}
              ...
              <li className={location.pathname === "/touromate-list" ? "active" : ""}>
                <Link className="collapsed" to="/touromate-list">
                  <span className="menu-bar__text">
                    <span className="crancy-menu-icon crancy-svg-icon__v1">
                      <svg
                        className="crancy-svg-icon"
              ...
              {/* 문의 사이드 메뉴 */}
              <li className={location.pathname === "/inquiry-list" ? "active" : ""}>
                <Link className="collapsed" to="/inquiry-list">
                  <span className="menu-bar__text">
                    <span className="crancy-menu-icon crancy-svg-icon__v1">
                      <svg
                        className="crancy-svg-icon"
                    ...
                    <span className="menu-bar__name">문의</span>
                  </span>
                  {/* <div className="crancy-menu-group">
                    <span href="#">
                      <img src={inboxEdit} />
              ...
              <li className={location.pathname === "/inbox" ? "active" : ""}>
                <Link className="collapsed" to="/inbox">
                  <span className="menu-bar__text">
                    ...
                    <span className="menu-bar__name">1:1문의</span>
                  </span>
                  <div className="crancy-menu-group">
                    <span href="#">
                      <img src={inboxEdit} />
